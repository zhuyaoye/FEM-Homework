...
//! CSJ--Rewrite the virtual function "Read" in the Basic class "CElement"
	// bool Read(ifstream &input, CMaterial *materials, CNode *nodes) override;
private:

//!	Calculate transformation matrix
	void CalculateTransformationMatrix(double T[12][12]); // Deleted by CSJ
